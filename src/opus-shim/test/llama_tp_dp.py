...
if not verify_min_gpu_count(min_gpus=_min_gpu_count):
    print(f"Need at least {_min_gpu_count} GPUs. Exiting.")
    sys.exit()
...
rank_log(_rank, logger, f"TP rank: {tp_rank}, DP rank: {dp_rank}")
...
# ---- Wrap in DDP --------------------------------------------------------
# Only wrap the outer model (TP already splits weights internally)
