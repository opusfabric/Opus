...
for LATENCY in "${LATENCIES[@]}"; do
    ...
    # --------------------------
    JOB="dp-8-pp-2-tp-4-pm-8b"
    CONFIG_FILE=${CONFIG_FILE:-"<path-to-opus>/Opus/torchtitan/opus-test/$JOB/llama3_8b_lb_dp8.toml"}
    TRAIN_FILE=${TRAIN_FILE:-"torchtitan.train"}
    COMM_PATTERN_PATH=${COMM_PATTERN_PATH:-"<path-to-opus>/Opus/evaluation/llama-3-3d-64-latency/comm_pattern_no_ctl_issue/comm_pattern"}
    OUTPUT_DIR="<path-to-opus>/Opus/torchtitan/opus-test/$JOB/output-opus-l_$LATENCY-$MODE-dp8"
