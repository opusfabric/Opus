...
#SBATCH -G 16
#SBATCH -q regular
#SBATCH -J opus-deepseek
#SBATCH --mail-user=ericdingg16@gmail.com
...
export USE_CUDA_STREAM="3" # only applies to provisioning
# --------------------------
...
# LATENCIES=(100 50 10 250 0 500 750 1000)
LATENCIES=(0 10 50 100 250 500 750 1000)
...
for LATENCY in "${LATENCIES[@]}"; do
    ...
    # --------------------------
    JOB="deepseek-pp-4-tp-4-pm"
    CONFIG_FILE=${CONFIG_FILE:-"<path-to-opus>/Opus/torchtitan/opus-test/$JOB/deepseek_v3_16b.toml"}
    TRAIN_FILE=${TRAIN_FILE:-"torchtitan.train"}
    COMM_PATTERN_PATH=${COMM_PATTERN_PATH:-"<path-to-opus>/Opus/evaluation/deepseek_v3_16b-2d-16-latency/comm_pattern/comm_pattern"}
    OUTPUT_DIR="<path-to-opus>/Opus/torchtitan/opus-test/$JOB/output-opus-l_$LATENCY-$MODE"
    export LOG_RANK=0,4,8,12
    ...
    export MODE=$MODE
    export USE_CUDA_STREAM=$USE_CUDA_STREAM
