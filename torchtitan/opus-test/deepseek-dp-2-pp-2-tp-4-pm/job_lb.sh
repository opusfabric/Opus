...
export RECONFIG_LATENCY=0 # in milliseconds
...
CONFIG_FILE=${CONFIG_FILE:-"~/Opus/torchtitan/opus-test/$JOB/deepseek_v3_16b.toml"}
...
# export NCCL_LAUNCH_ORDER_IMPLICIT=1 #overlapped execution
