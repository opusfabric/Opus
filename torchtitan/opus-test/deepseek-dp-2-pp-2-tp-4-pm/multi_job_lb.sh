...
for LATENCY in "${LATENCIES[@]}"; do
    ...
    # --------------------------
    JOB="deepseek-dp-2-pp-2-tp-4-pm"
    CONFIG_FILE=${CONFIG_FILE:-"<path-to-opus>/Opus/torchtitan/opus-test/$JOB/deepseek_v3_16b.toml"}
    TRAIN_FILE=${TRAIN_FILE:-"torchtitan.train"}
    COMM_PATTERN_PATH=${COMM_PATTERN_PATH:-"<path-to-opus>/Opus/evaluation/deepseek_v3_16b-3d-16-latency/comm_pattern/comm_pattern"}
    OUTPUT_DIR="<path-to-opus>/Opus/torchtitan/opus-test/$JOB/output-opus-l_$LATENCY-$MODE-cuda-pre"
