...
for LATENCY in "${LATENCIES[@]}"; do
    ...
    # --------------------------
    JOB="dp-4-pm"
    CONFIG_FILE=${CONFIG_FILE:-"<path-to-opus>/Opus/torchtitan/opus-test/$JOB/llama3_8b_lb_1.toml"}
    ...
    OUTPUT_DIR="<path-to-opus>/Opus/torchtitan/opus-test/$JOB/output-opus-l_$LATENCY-${MODE}_1"
