...
DP=4
MIXED_PRECISION=1
SCALE_OUT_SWEEPS="12.5 25 100 200"
...
if [ ${GOOD} -eq 1 ]; then
    ...
    echo "WARNING: for a fresh run, please delete the existing output directories at ${RECONFIG_BACKEND}/examples/llama_dp${DP}_pp${PP}_tp${TP}_batch_256_mb-1_96stack_seq4096_*BW and re-run this script."
else
